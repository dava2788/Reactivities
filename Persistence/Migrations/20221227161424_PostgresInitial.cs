        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivivityId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsHost = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivityAttendees", x => new { x.AppUserId, x.ActivivityId });
                    table.ForeignKey(
                        name: "FK_ActivityAttendees_Activities_ActivivityId",
                        column: x => x.ActivivityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityAttendees_ActivivityId",
